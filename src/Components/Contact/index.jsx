...
function Contact() {
  return (
    <div id='contacts' className="flex flex-col justify-evenly items-center mx-auto text-center py-5 gap-16 bg-gray-100">
       {/* Contact-Text */}
        <div className='mx-auto max-w-md sm:max-w-2xl mt-8 flex flex-col justify-between gap-10 px-5'>
