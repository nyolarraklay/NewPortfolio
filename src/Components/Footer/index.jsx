    ...
    <div className='bg-black p-10 w-full relative'>
        <div>
            <div className='flex items-center justify-between text-white font-semibold flex-wrap gap-5'>
                ...
                <a href="https://www.linkedin.com/in/ernesto-jr-osorio-16b698248/" target="_blank" aria-label="Go to my linked-in account"><img src={linkedin} alt="" className='size-10' /></a>
